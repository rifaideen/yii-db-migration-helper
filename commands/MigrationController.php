...
class MigrationController extends \yii\console\Controller
{
    ...
    public function actionApply($table, $previewData = false)
    {
        try {
            ...
            echo "The data migration has been split into $pages chunk(s), based on the limit you've choosen.\n";
    ...
    public function actionPrintQuery($table1, $table2)
    {
        try {
            ...
            $sql = "INSERT INTO `squeeze-v2`.$table2(SELECT $columns FROM `squeeze-staging-b`.$table1 as t);";
     ...
     * @return int Exit code
     */
    public function actionExecuteQuery($table)
    {
        try {
            echo "Reading configuration\n";
